...
typedef enum
{
    ...
    AVC_SEI_USER_DATA_REGISTERED_ITU_T_T35 = 4,
    AVC_SEI_USER_DATA_UNREGISTERED = 5,
    AVC_SEI_RECOVERY_POINT = 6,
    AVC_SEI_DEC_REF_PIC_MARKING_REPETITION = 7,
    AVC_SEI_SPARE_PIC = 8,
    AVC_SEI_SCENE_INFO = 9,
    AVC_SEI_SUB_SEQ_INFO = 10,
    AVC_SEI_SUB_SEQ_LAYER_CHARACTERISTICS = 11,
    AVC_SEI_SUB_SEQ_CHARACTERISTICS = 12,
    AVC_SEI_FULL_FRAME_FREEZE = 13,
    AVC_SEI_FULL_FRAME_FREEZE_RELEASE = 14,
    AVC_SEI_FULL_FRAME_SNAPSHOT = 15,
    AVC_SEI_PROGRESSIVE_REFINEMENT_SEGMENT_START = 16,
    AVC_SEI_PROGRESSIVE_REFINEMENT_SEGMENT_END = 17,
    AVC_SEI_MOTION_CONSTRAINED_SLICE_GROUP_SET = 18,
    AVC_SEI_FILM_GRAIN_CHARACTERISTICS = 19,
    AVC_SEI_DEBLOCKING_FILTER_DISPLAY_PREFERENCE = 20,
...
/**
This structure contains information in an SEI NAL.
Some variables may be removed from the structure if they are found to be useless to store.
@publishedAll
*/
#define MAX_SEI_PAYLOAD 256
typedef struct tagAVCSei
{
    uint payload_type;
    uint payload_size;
    char payload[MAX_SEI_PAYLOAD];
} AVCSei;
